      ...
      >
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-row>
                <el-col :span="6"
                  ><div class="blogFilesInfoName">Name:</div></el-col
                >
                <el-col :span="18"
              ...
              <el-row style="margin-top: 4px">
                <el-col :span="6"
                  ><div class="blogFilesInfoName">Size:</div></el-col
                >
                <el-col :span="18"
              ...
              <el-row style="margin-top: 4px">
                <el-col :span="6"
                  ><div class="blogFilesInfoName">Type:</div></el-col
                >
                <el-col :span="18"
          ...
          <el-table-column align="center" min-width="20%" label="operate">
            <template slot-scope="scope">
              <el-button size="mini" plain @click="handleDownload(scope.row)"
                >Download</el-button
              >
              <el-button size="mini" plain @click="handlePreview(scope.row)"
                >Preview</el-button
              >
            </template>
          </el-table-column>
        ...
        <div class="author">
          <ul>
            ...
            <li>PublishedTime: {{ blog.createTime }}</li>
          </ul>
        </div>
        <el-card shadow="never" class="comments">
          <div class="header" style="padding-bottom: 10px">Comments</div>
          <comment></comment>
        </el-card>
      </el-card>
    </el-col>
